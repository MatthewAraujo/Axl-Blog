        ...
        {withImage && (
          <div className="hidden xl:block flex-1 aspect-square relative">
            <Image
              ...
              alt=""
              fill
              className="rounded-full border-2 border-solid border-slate-400 object-cover"
            />
          </div>
        )}
        <div className=" w-ful xl:w-3/4 flex-col gap-1">
          <Badge
            className="py-1 px-2 rounded-xl  bg-orange-600 text-xs text-slate-200 font-normal w-max "
            variant="outline"
          >
            Travel
          </Badge>
